...
public class TacticalWindCharge extends Module {
    ...
    private void updateCombatState() {
        hasElytraEquipped = mc.player.getEquippedStack(net.minecraft.entity.EquipmentSlot.CHEST).getItem() == Items.ELYTRA;
